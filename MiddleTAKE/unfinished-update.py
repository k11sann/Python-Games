...
╚═╝     ╚═╝╚═╝╚═════╝ ╚═════╝ ╚══════╝╚══════╝   ╚═╝   ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝v2.00
 ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰
        ...
        Рекомендуется открыть терминал по-выше [ не запускать в CMD, не видны символы ]
 ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰
        Press F5 to PLAY, *required Python and VS
 ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰ ▰
    ...
    def gameResult(self, result):
        if result==True:
            ...
            if self.dif=="attempts":
                print("◄    ПОПЫТКА : "+str(self.attempt)+"/"+str(self.maxAttempts))
                if self.attempt>=self.maxAttempts:
                    self.attempt=0
                    print("◄    ПЕРЕКИДЫВАЮ НА 3 УРОВНЯ НАЗАД")
                    self.current_lvl-=3
...
# 4. Попытки прохождения (от 5 до 10) Если попыток 0, то -3 уровней
