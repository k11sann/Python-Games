...
def gameLoop():
    while(True):
        ...
        if mainGame.game_status=="inWait" or mainGame.game_status=="title":
            wait = input("Нажмите ENTER чтобы продолжить")
            mainGame.game_status="inGame"
        elif mainGame.gameEnd==False and mainGame.game_status=="inGame":
            mainGame.setUp()
